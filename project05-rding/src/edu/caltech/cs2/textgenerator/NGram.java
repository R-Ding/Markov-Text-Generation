...
public class NGram implements Iterable<String>, Comparable<NGram> {
    ...
    public int compareTo(NGram other) {
        if (this.data.size() > other.data.size()) {
            ...
            Iterator thisIterator = this.data.iterator();
            Iterator thatIterator = other.data.iterator();
            while (thisIterator.hasNext()) {
                String first = (String) thisIterator.next();
                String second = (String) thatIterator.next();
    ...
    public boolean equals(Object o) {
        ...
        Iterator thisIterator = this.data.iterator();
        Iterator thatIterator = ((NGram) o).data.iterator();
        while (thisIterator.hasNext()) {
    ...
    public int hashCode() {
        int result = 0;
        int[] hashes = new int[this.data.size()];
        int c = 0;
        for (String s : this.data) {
            hashes[c]= s.hashCode();
            c++;
